...
public class RegisterActivity extends AppCompatActivity {
    ...
    private EditText firstNameInput, lastNameInput, middleNameInput, suffixInput;
    ...
    private void handleRegister(){
        ...
        RegisterRequest request = new RegisterRequest(
                firstName,middleName,lastName,suffix,email,contact,address,password,confirmPassword
        );
